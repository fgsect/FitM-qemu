...
Most additions center around CRIU integration and the network emulation layer in `syscall.c <https://github.com/fgsect/FitM-qemu/blob/fitm/linux-user/syscall.c>`_.
